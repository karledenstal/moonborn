...
Function Init()
    ...
    ; Make sure it's either Farkas or Aela
    if selectedObserver == (CentralQuest as CompanionsHousekeepingScript).Farkas.GetActorReference()
        selectedObserver = (CentralQuest as CompanionsHousekeepingScript).Farkas.GetActorReference()
    else 
        selectedObserver = (CentralQuest as CompanionsHousekeepingScript).Aela.GetActorReference()
    endif
